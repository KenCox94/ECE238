...
HD_PWD='C:/Repo/ECE238/LAB0B/LAB0B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LAB0B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LAB0B.tcl -notrace
