...
HD_PWD='C:/Repo/ECE238/DFlipFlop/DFlipFlop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DFFSingleBit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DFFSingleBit.tcl -notrace
