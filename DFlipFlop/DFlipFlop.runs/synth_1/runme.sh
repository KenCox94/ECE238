...
HD_PWD='C:/Repo/ECE238/DFlipFlop/DFlipFlop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFFSingleBit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFFSingleBit.tcl
