...
HD_PWD='C:/Repo/ECE238/Display/Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DispDigit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DispDigit.tcl -notrace
