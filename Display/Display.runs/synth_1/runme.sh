...
HD_PWD='C:/Repo/ECE238/Display/Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DispDigit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DispDigit.tcl
