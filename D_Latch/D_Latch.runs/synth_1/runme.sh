...
HD_PWD='C:/Repo/ECE238/D_Latch/D_Latch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DLatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DLatch.tcl
