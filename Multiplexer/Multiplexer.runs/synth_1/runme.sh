...
HD_PWD='C:/Repo/ECE238/Multiplexer/Multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplexer_8_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplexer_8_1.tcl
